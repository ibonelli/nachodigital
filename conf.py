...
BLOG_AUTHOR = "Ignacio Bonelli"  # (translatable)
BLOG_TITLE = "NachoDigital"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.nachodigital.com.ar/"
#SITE_URL = "http://127.0.0.1:8000/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.nachodigital.com.ar/"
BLOG_EMAIL = "ignacio@nachodigital.com.ar"
BLOG_DESCRIPTION = "Welcome to NachoDigital"  # (translatable)
...
BODY_END = """
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-6YNZZZKVVS"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-6YNZZZKVVS');
</script>
"""
...
# For debugging use in command line
# export NIKOLA_DEBUG=1 ; export NIKOLA_SHOW_TRACEBACKS=1
# unset NIKOLA_DEBUG ; unset NIKOLA_SHOW_TRACEBACKS
